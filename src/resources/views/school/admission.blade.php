...
<div class="py-20 text-center">
    <h1 class="text-4xl font-bold text-gray-900 mb-4">Admission</h1>
    <p class="text-xl text-gray-600">Coming Soon - Admission form and information will be displayed here.</p>
