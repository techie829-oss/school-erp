...
<head>
    ...
    <meta name="description" content="Manage users in School ERP System">
        ...
        <div class="sidebar w-64 flex-shrink-0">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3 text-white bg-white bg-opacity-20 rounded-lg">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
