...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('admin.users.show', $user) }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors font-medium">
            ...
            <form method="POST" action="{{ route('admin.users.update-password', $user) }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" 
                           ...
                           class="form-input @error('current_password') border-red-300 @enderror"
