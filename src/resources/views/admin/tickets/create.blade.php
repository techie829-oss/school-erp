...
@section('page-description', 'Create a new support ticket')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500">Fill out the form below to create a new support ticket</p>
        </div>

        <form action="{{ route('admin.tickets.store') }}" method="POST" class="px-6 py-6">
            @csrf
