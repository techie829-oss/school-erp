            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Database
                        </th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($tenants as $tenant)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ ($tenant->data['active'] ?? true) ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                    {{ ($tenant->data['active'] ?? true) ? 'Active' : 'Inactive' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.tenants.toggle-status', $tenant) }}"
                                        ...
                                        @csrf
                                        <button type="submit" class="text-{{ ($tenant->data['active'] ?? true) ? 'red' : 'green' }}-600 hover:text-{{ ($tenant->data['active'] ?? true) ? 'red' : 'green' }}-900"
                                                title="{{ ($tenant->data['active'] ?? true) ? 'Deactivate' : 'Activate' }}">
