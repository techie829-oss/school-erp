    ...
    <nav class="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-8 flex items-center space-x-6">
                        <a href="{{ route('landing.home') }}" class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-blue-600 transition-colors {{ request()->routeIs('landing.home') ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : '' }}">
                            Home
                        </a>
                        <a href="{{ route('landing.features') }}" class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-blue-600 transition-colors {{ request()->routeIs('landing.features') ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : '' }}">
                            Features
                        </a>
                        <a href="{{ route('landing.pricing') }}" class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-blue-600 transition-colors {{ request()->routeIs('landing.pricing') ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : '' }}">
                            Pricing
                        </a>
                        <a href="{{ route('landing.about') }}" class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-blue-600 transition-colors {{ request()->routeIs('landing.about') ? 'text-blue-600 border-b-2 border-blue-600 pb-1' : '' }}">
                            About
                        </a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="{{ route('landing.contact') }}" class="px-4 py-2 rounded-lg text-sm font-medium text-secondary-600 bg-secondary-100 hover:bg-secondary-200 border border-secondary-300 transition-colors">
                        Contact Us
                    </a>
                    <a href="{{ route('landing.pricing') }}" class="px-6 py-2 rounded-lg text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 transition-colors">
                        View Pricing
                    </a>
                </div>
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-100">
                <a href="{{ route('landing.home') }}" class="block px-3 py-2 text-base font-bold text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors {{ request()->routeIs('landing.home') ? 'text-blue-600 bg-blue-100 border-l-3 border-blue-600 pl-4' : '' }}">
                    Home
                </a>
                <a href="{{ route('landing.features') }}" class="block px-3 py-2 text-base font-bold text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors {{ request()->routeIs('landing.features') ? 'text-blue-600 bg-blue-100 border-l-3 border-blue-600 pl-4' : '' }}">
                    Features
                </a>
                <a href="{{ route('landing.pricing') }}" class="block px-3 py-2 text-base font-bold text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors {{ request()->routeIs('landing.pricing') ? 'text-blue-600 bg-blue-100 border-l-3 border-blue-600 pl-4' : '' }}">
                    Pricing
                </a>
                <a href="{{ route('landing.about') }}" class="block px-3 py-2 text-base font-bold text-gray-600 hover:text-blue-600 hover:bg-blue-100 transition-colors {{ request()->routeIs('landing.about') ? 'text-blue-600 bg-blue-100 border-l-3 border-blue-600 pl-4' : '' }}">
                    About
                </a>
            ...
            <div class="pt-4 pb-3 border-t border-gray-200 px-2 sm:px-3 space-y-3">
                <a href="{{ route('landing.contact') }}" class="block w-full text-center px-4 py-3 text-base font-medium text-secondary-600 bg-secondary-100 hover:bg-secondary-200 border border-secondary-300 transition-colors rounded-lg">
                    Contact Us
                </a>
                <a href="{{ route('landing.pricing') }}" class="block w-full text-center px-6 py-3 text-base font-medium text-white bg-primary-600 hover:bg-primary-700 transition-colors rounded-lg">
                    View Pricing
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ route('landing.features') }}" class="text-secondary-300 hover:text-white transition-colors">Features</a></li>
                        <li><a href="{{ route('landing.pricing') }}" class="text-secondary-300 hover:text-white transition-colors">Pricing</a></li>
                        <li><a href="{{ route('landing.about') }}" class="text-secondary-300 hover:text-white transition-colors">About Us</a></li>
                        <li><a href="{{ route('landing.contact') }}" class="text-secondary-300 hover:text-white transition-colors">Contact</a></li>
                    </ul>
                </div>
