...
<head>
    ...
    <style>
        @php $tenantService =app(\App\Services\TenantService::class);
        ...
        <div class="p-6">
            ...
            <nav class="space-y-2">
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.dashboard') ? 'text-white bg-white bg-opacity-20' : 'text-purple-200 hover:text-white hover:bg-white hover:bg-opacity-10' }} rounded-lg transition-colors">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.users.*') ? 'text-white bg-white bg-opacity-20' : 'text-purple-200 hover:text-white hover:bg-white hover:bg-opacity-10' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.tenants.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.tenants.*') ? 'text-white bg-white bg-opacity-20' : 'text-purple-200 hover:text-white hover:bg-white hover:bg-opacity-10' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.system.overview') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.system.overview') ? 'text-white bg-white bg-opacity-20' : 'text-purple-200 hover:text-white hover:bg-white hover:bg-opacity-10' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mt-6 pt-6 border-t border-purple-700">
                    <h3 class="px-4 text-sm font-semibold text-purple-100 uppercase tracking-wider mb-3">Quick Actions
                    </h3>

                    <a href="{{ route('admin.tickets.index') }}"
                        class="flex items-center px-4 py-3 text-purple-200 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.notifications.index') }}"
                        ...
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 17h5l-5 5v-5zM4.5 19.5h15a2 2 0 002-2v-6.5a2 2 0 00-2-2h-15a2 2 0 00-2 2v6.5a2 2 0 002 2z" />
                        </svg>
                        Notifications
                    </a>
                </div>
            ...
            <div class="px-4 sm:px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <button
                            class="mr-4 text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 rounded-md p-1"
                    ...
                    <div class="relative">
                        <button id="userMenuButton"
                            class="flex items-center space-x-3 p-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50">
                            <!-- User Avatar -->
                            <div class="relative">
                                <div
                                    class="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full flex items-center justify-center shadow-md">
                            ...
                            <div class="hidden sm:block text-left">
                                ...
                                <div class="text-xs text-gray-500">{{ auth()->user()->email ?? 'admin@example.com' }}
                                </div>
                            </div>
                                ...
                                <a href="{{ route('admin.notifications.index') }}"
                                    ...
                                    <div class="relative w-4 h-4 mr-3">
                                        ...
                                        <span id="notification-count"
                                            class="absolute -top-1 -right-1 w-3 h-3 bg-red-500 text-white text-xs rounded-full flex items-center justify-center text-[10px] hidden">0</span>
                                    </div>
                                    Notifications
                                    <span id="notification-count-text"
                                        class="ml-auto bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full hidden">0</span>
                                </a>
