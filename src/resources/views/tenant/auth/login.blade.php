...
<head>
    ...
    <title>Login - {{ $tenant->data['name'] ?? 'School Management System' }}</title>
    ...
    <div class="w-full max-w-md px-6">
        ...
        <div class="text-center mb-8">
            ...
            @if(isset($tenant->data['database_strategy']))
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-yellow-100 border border-orange-200">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('tenant.login.post', ['tenant' => request()->route('tenant')]) }}">
                @csrf
