...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="GET" action="{{ url('/admin/attendance/students/mark') }}" class="space-y-4">
    ...
    <!-- Attendance Form -->
    @if($students->count() > 0)
    <form action="{{ url('/admin/attendance/students/save') }}" method="POST">
        @csrf
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="mt-6 flex justify-between items-center pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700">
                    ...
                    Save Attendance ({{ $students->count() }} students)
                </button>
            </div>
        </div>
    </form>
    ...
    <div class="bg-white shadow rounded-lg p-12 text-center">
        ...
        <p class="mt-1 text-sm text-gray-500">Choose a class and section from the dropdowns above to mark attendance.</p>
    </div>
    @endif
</div>
