...
<head>
    ...
    <title>Teacher Attendance Report - {{ $tenant->data['name'] ?? 'School ERP' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <div class="value">{{ $reportData['summary']['late'] ?? 0 }}</div>
            </div>
            <div class="summary-item">
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Check Out</th>
                <th>Hours</th>
                @if(isset($reportData['type']) && in_array($reportData['type'], ['teacher_wise', 'department_wise']))
                <th>Total Days</th>
                <th>Present</th>
                <th>Absent</th>
                <th>Percentage</th>
    ...
    <div class="footer">
        ...
        <p>{{ $tenant->data['name'] ?? 'School ERP' }} - Teacher Attendance Management System</p>
    </div>
</body>
</html>
