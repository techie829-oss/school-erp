...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-4">
        <form method="GET" action="{{ url('/admin/examinations/results') }}" class="space-y-4">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ url('/admin/examinations/results') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Clear
                </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500">{{ $result->schoolClass->class_name ?? '' }} {{ $result->section->section_name ?? '' }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            @else
                                ...
                                <div class="text-xs text-gray-500">{{ number_format($result->percentage, 2) }}%</div>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            @if($result->grade)
                                ...
                                @if($result->gpa)
                                    <div class="text-xs text-gray-500">GPA: {{ $result->gpa }}</div>
                                @endif
                            @else
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                ...
                                $color = $statusColors[$result->status] ?? 'bg-gray-100 text-gray-800';
                            @endphp
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ url('/admin/examinations/results/' . $result->id . '/edit') }}" class="text-primary-600 hover:text-primary-900">Edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Results will appear here once entered</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
