...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form action="{{ url('/admin/examinations/grade-scales') }}" method="POST">
        @csrf
        <div class="bg-white shadow rounded-lg p-6 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="grade_name" id="grade_name" value="{{ old('grade_name') }}" required
                    ...
                    <p class="mt-1 text-xs text-gray-500">Letter grade (A+, A, B+, B, C+, C, D, F)</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="min_percentage" id="min_percentage" value="{{ old('min_percentage') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="max_percentage" id="max_percentage" value="{{ old('max_percentage') }}" required
                        step="0.01" min="0" max="100"
            ...
            <div>
                ...
                <input type="number" name="gpa_value" id="gpa_value" value="{{ old('gpa_value') }}"
                    step="0.01" min="0" max="10"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                <p class="mt-1 text-xs text-gray-500">GPA value for this grade (e.g., 4.0, 3.5, 3.0)</p>
            </div>
            ...
            <div class="flex items-center space-x-6">
                <div class="flex items-center">
                    <input type="checkbox" name="is_pass" id="is_pass" value="1" {{ old('is_pass', true) ? 'checked' : '' }}
