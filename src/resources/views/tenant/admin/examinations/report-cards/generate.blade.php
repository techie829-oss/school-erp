        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ url('/admin/examinations/report-cards') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ml-2">Report Cards</a>
                </div>
            </li>
    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Generate report cards for {{ $exam->exam_name }}
            </p>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ url('/admin/examinations/report-cards') }}" method="POST" class="max-w-2xl">
        @csrf
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="generate_missing" class="ml-2 block text-sm text-gray-700">
                            Generate only for students without report cards
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center">
                ...
                <label for="is_published" class="ml-2 block text-sm text-gray-700">
                    Publish report cards immediately after generation
                </label>
            </div>
        </div>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ url('/admin/examinations/report-cards') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                Cancel
            </a>
