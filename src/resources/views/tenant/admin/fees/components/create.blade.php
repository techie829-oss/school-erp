    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Add a new fee type or component
            </p>
        </div>
    ...
    <form action="{{ url('/admin/fees/components') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="type" id="type" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm @error('type') border-red-300 @enderror">
                        ...
                        <option value="recurring" {{ old('type') == 'recurring' ? 'selected' : '' }}>Recurring (Monthly/Quarterly/Annually)</option>
                        <option value="one_time" {{ old('type') == 'one_time' ? 'selected' : '' }}>One Time (Admission, Registration, etc.)</option>
                    </select>
                </div>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Component Types</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <p><strong>Recurring:</strong> Fees charged regularly (Monthly, Quarterly, Annually)</p>
                        <p class="mt-1"><strong>One Time:</strong> Fees charged once (Examples: Admission Fee, Registration Fee)</p>
                    </div>
                </div>
            </div>
        </div>
