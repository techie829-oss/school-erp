...
<div class="space-y-6">
    ...
    <div class="md:flex md:items-center md:justify-between">
        ...
        <div class="mt-4 flex md:mt-0 md:ml-4">
            <a href="{{ url('/admin/users/create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $teachersCount }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $adminsCount }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6">
        <form method="GET" action="{{ url('/admin/users') }}" class="space-y-4 sm:space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="user_type" id="user_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                        <option value="">All Types</option>
                        <option value="school_admin" {{ request('user_type') == 'school_admin' ? 'selected' : '' }}>School Admin</option>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <a href="{{ url('/admin/users') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Clear Filters
                </a>
                @endif
            </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div class="p-4 sm:p-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center space-x-4 flex-1 min-w-0">
                        <div class="flex-shrink-0">
                            <div class="h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-primary-100 flex items-center justify-center">
                                <span class="text-primary-600 font-semibold text-lg sm:text-xl">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="mt-2 flex flex-col sm:flex-row sm:items-center gap-2 text-sm text-gray-500">
                                <div class="flex items-center">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0 whitespace-nowrap">
                        <a href="{{ url('/admin/users/' . $user->id) }}" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                            View
                        </a>
                        <span class="text-gray-300">|</span>
                        <a href="{{ url('/admin/users/' . $user->id . '/edit') }}" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                            Edit
                        </a>
                        @if($user->id !== auth()->id())
                        <span class="text-gray-300">|</span>
                        <form action="{{ url('/admin/users/' . $user->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this user?');">
                            @csrf
                            @method('DELETE')
        ...
        <div class="p-12 text-center">
            ...
            <div class="mt-6">
                <a href="{{ url('/admin/users/create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700">
                    <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                    Add User
