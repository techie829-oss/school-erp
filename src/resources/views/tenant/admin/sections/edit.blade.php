    ...
    <form action="{{ url('/admin/sections/' . $section->id) }}" method="POST" class="max-w-2xl">
        ...
        <div class="bg-white shadow rounded-lg p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div>
                ...
                <input type="text" name="section_name" id="section_name" value="{{ old('section_name', $section->section_name) }}" required
        ...
        <div class="mt-6 flex flex-col sm:flex-row justify-end gap-3">
            <a href="{{ url('/admin/sections') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                Cancel
            </a>
