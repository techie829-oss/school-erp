...
<div class="space-y-6">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li><a href="{{ url('/admin/library/categories') }}" class="text-sm font-medium text-gray-700 hover:text-primary-600">Categories</a></li>
            <li><span class="text-gray-500">/</span></li>
    ...
    <form action="{{ url('/admin/library/categories/' . $category->id) }}" method="POST" class="max-w-2xl">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $category->code) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                </div>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ url('/admin/library/categories') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">Cancel</a>
