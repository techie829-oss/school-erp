...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="{{ url('/admin/teachers') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ url('/admin/teachers') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                Cancel
            </a>
